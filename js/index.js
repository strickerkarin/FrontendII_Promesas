...
/* let nombreCompletox = Object.values(baseDeDatos.results[0].name).join(' '); */
...
consultandoBaseDeDatos.then((respuesta) => {
...
function renderizarDatosUsuario(datos) {
    ...
    const template = 
    `<p>
        Usuario: ${datos.results[0].name.title}  ${datos.results[0].name.first}  ${datos.results[0].name.last}
    </P>
    <P>
        Email: ${datos.results[0].email}    
    </p>
    <img src=${datos.results[0].picture.thumbnail} alt="foto">`
